"""
ML Model Training and Inference Service for LearnPulse.

Uses a tree-based gradient boosting classifier with 5-fold cross-validation
and calibrated probability outputs. Implements model versioning and persistence.
"""
