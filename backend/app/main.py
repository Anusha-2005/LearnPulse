"""
FastAPI Main Application — LearnPulse.
...
async def lifespan(app: FastAPI):
    ...
    logger.info("=" * 60)
    logger.info("LearnPulse — starting up")
    logger.info("=" * 60)
...
app = FastAPI(
    ...
    description=(
        "LearnPulse — ML-powered student analytics and risk prediction. "
