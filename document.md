...
## 1. Project Overview
This document breaks down the end-to-end architecture, technical decisions, machine learning methodologies, and data processing pipelines of **LearnPulse**. Use this guide to understand **what** we built, **why** we chose specific tools, and **how** it works under the hood so that anyone on the team can explain it confidently to a reviewer.
